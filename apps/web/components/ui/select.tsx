...
/** Native <select>, styled to match the design system. Avoids a heavier Radix dependency
 * for a form control that doesn't need custom option rendering anywhere in this app. */
